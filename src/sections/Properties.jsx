...
export const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        id="properties"
        className="lg:w[90%] m-auto lg:px-20 px-6 py-20
        ...
        >
          {property.map((item, index) => (
            ...
            >
              <div
                id="image-box"
                className="bg-cover bg-center h-[250px]
            rounded-xl p-4 flex flex-col justify-between items-end"
                style={{
              ...
              >
                <div id="top" className="flex justify-between items-end w-full">
                  <div>
                    <button
                      className="px-3 py-1 bg-red-600 hover:bg-white
    hover:text-black text-white rounded-full text-[13px]"
                    >
                      Feature
                    </button>
                  </div>
    ...
    hover:text-black text-white rounded-full text-[13px]"
              ...
              gap-2 w-full'>
                ...
                <h1 className='text-2xl text-red-600 font-bold dark:text-black'>
                  {item.price}
                </h1> 
                ...
                w-full mt-2'>
                  ...
                  <div className='flex justify-center item-center gap-4'>
                    ...
                    <div className='p-2 border-2 border-gray-200 hover:bg-black' 
                    cursor-pointer transform hover:scale-110 transition-transform
                    duration-300><FaHeart className='size-4 text-red-400'/> 
                    </div>
