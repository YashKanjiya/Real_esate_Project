  ...
  return (
    <>
      <div className={`${darkMode ? 'dark bg-black':'light bg-transparent'} pb-20`}>
        <section id='services' className={`${darkMode ? 'dark bg-gray-800':'light bg-red-100'} lg:w-[95%] w-full h-fit m-auto 
        rounded-xl flex flex-col justify-center items-start lg:px-20 px-6 py-20 gap-10`}>
          ...
          <div id='service-box' className='grid lg:grid-cols-3 grid-cols-1
          justifty-center items-center gap-8'>
            {
              service.map((item,index)=>(
                ...
                border-red-600 hover:bg-red-300 cursor-pointer'>
                  ...
                  font-semiboldp-0 dark:text-white'>Read More</button>
