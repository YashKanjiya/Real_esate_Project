        ...
        <div className={`${darkMode ? 'dark bg-black':'light bg-transparent'}`}>
          ...
          py-20 gap-20'>
            <div className='flex flex-col justify-center items-start gap-4'>
              ...
              font-semibold leading-10'>what is our client<br></br>saying about us</h1>
            </div>
...

            {
              client.map((item,index)=>(
                ...
                className='bg-white dark:bg-gray-900 hover:bg-red-100 cursor-point
                p-12 flex flex-col justify-center items-center gap-6 rounded-xl
                w-full'>
